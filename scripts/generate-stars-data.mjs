...
const outputExtra9Path = resolve(ROOT, 'src/generated/stars-data-extra-9.js');
const outputExtra10Path = resolve(ROOT, 'src/generated/stars-data-extra-10.js');
...
const extra9Output = `// Auto-generated by scripts/generate-stars-data.mjs\n` +
`// Source: data/stars.csv\n` +
`// Filter: ${EXTRA8_MAX_VMAG} < Vmag <= ${EXTRA9_MAX_VMAG}\n` +
`export const STAR_EXTRA_9_META = ${JSON.stringify({ sourceRows: lines.length - 1, usedRows: usedExtra9, minExclusiveVmag: EXTRA8_MAX_VMAG, maxVmag: EXTRA9_MAX_VMAG })};\n\n` +
`export const STAR_EXTRA_9_LAYERS = ${layersToJsArray(extra9Layers)};\n`;

const extra10Output = `// Auto-generated by scripts/generate-stars-data.mjs\n` +
`// Source: data/stars.csv\n` +
`// Filter: ${EXTRA9_MAX_VMAG} < Vmag <= ${EXTRA10_MAX_VMAG}\n` +
`export const STAR_EXTRA_10_META = ${JSON.stringify({ sourceRows: lines.length - 1, usedRows: usedExtra10, minExclusiveVmag: EXTRA9_MAX_VMAG, maxVmag: EXTRA10_MAX_VMAG })};\n\n` +
`export const STAR_EXTRA_10_LAYERS = ${layersToJsArray(extra10Layers)};\n`;
...
writeFileSync(outputExtra9Path, extra9Output, 'utf-8');
writeFileSync(outputExtra10Path, extra10Output, 'utf-8');
...
console.log(`Generated ${outputExtra9Path} with ${usedExtra9} stars.`);
console.log(`Generated ${outputExtra10Path} with ${usedExtra10} stars.`);
